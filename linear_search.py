...
# Generate a list with random numbers ensuring 59 is included
numbers = random.sample(range(1, 100), 19) + [59]
...
def on_draw():
    ...
    for i, number in enumerate(numbers):
        ...
        if i == current_index and not search_complete:
            color = (255, 69, 23)  # Red for the current box being checked
        elif i == found_index:
            color = (255, 210, 36)  # Yellow if 59 is found
        else:
            color = (164, 162, 203)  # Blue for unchecked or passed boxes
